    ...
    <div className="flex h-screen w-full items-center justify-center pl-10 pr-10">
      <div className="m-auto">
        ...
        <p className="mt-6">
          ...
          My current work has led me to specialise in frontend development using TypeScript and
        ...
        <p className="">
          ...
          with my friends and faimily. I also love going camping, always looking for new places to
          explore. Over the Last 2 years I built a campervan with the help of my partner, which we
          use to explore all different places.
        </p>
      </div>
    </div>
  );
